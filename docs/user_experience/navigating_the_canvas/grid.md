...
The grid is like the lines on graph paper: useful for alignment but not part of the drawing. It's drawn with thin lines at low opacity — present enough to guide the eye but quiet enough to ignore when it's not needed.
