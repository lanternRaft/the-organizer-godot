...
The legend builds itself. As the user changes a shape's color, the legend updates immediately — no delay, no save trigger. The user just starts using red shapes, and suddenly the legend shows red with a name they can click to customize.
