# User Experience — Document Index
...
| [`creating_elements.md`](creating_elements.md) | Toolbar and tool switching, placing ovals/circles, dragging anchor dots to create curved arrows between shapes, planned node markers |
...
| Node markers (planned) | `creating_elements.md` |
