...
func test_drag_move_emits_incremental() -> void:
	...
	element.multi_drag_moved.connect(func(d: Vector2) -> void:
...
func test_drag_end_emits_signals() -> void:
	...
	element.anchor_changed.connect(func() -> void:
		anchor_fired = true
	)
	element.multi_drag_ended.connect(func() -> void:
		multi_fired = true
	)
...
func test_handle_click_default_behavior() -> void:
	...
	element.clicked.connect(func(_event: InputEvent, el: Node) -> void:
		signal_fired["fired"] = true
		signal_fired["ref"] = el
	)
