...
func test_camera_moved_emitted_on_pan() -> void:
	...
	controller.connect("camera_moved", func() -> void: signal_result["fired"] = true)
...
func test_camera_moved_emitted_on_zoom() -> void:
	...
	controller.connect(
		"zoom_changed", func(_level: float) -> void: signal_result["zoom_fired"] = true
	)
	controller.connect("camera_moved", func() -> void: signal_result["moved_fired"] = true)
